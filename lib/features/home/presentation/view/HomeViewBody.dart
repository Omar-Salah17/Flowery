              ...
              children: [
                Padding(
                  padding: EdgeInsets.only(left: 16).r,
                    child: Text("Categories",style: AppTextStyles.instance.textStyle18,)
                ),
                Spacer(),
                Padding(
                  ...
                  child: InkWell(
                   onTap: (){
                    ...
                    child: Text("View All",style: AppTextStyles.instance.textStyle12.copyWith(
                      color: PalletsColors.mainColorBase,
                      decoration: TextDecoration.underline,
                      decorationColor:PalletsColors.mainColorBase,
                      decorationThickness: 2, // Optional: Set thickness of the underline
                    ),),
                  ),
                ),
              ],
