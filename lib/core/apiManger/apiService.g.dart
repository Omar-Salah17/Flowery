...
class _ApiService implements ApiService {
  ...
  @override
  Future<CartResponse> addToCart(AddProductRequest addProductRequest) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final _data = <String, dynamic>{};
  ...
  @override
  Future<CartResponse> deleteCartItem(String cartItemId) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
  ...
  Future<BestSellerModel> getBestSellerProduct() async {
    ...
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<BestSellerModel>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            'best-seller',
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late BestSellerModel _value;
    try {
      _value = BestSellerModel.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
    }
  ...
  @override
  Future<LoggedUserAddressModel> getLoggedUserAddress() async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<LoggedUserAddressModel>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            'addresses',
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late LoggedUserAddressModel _value;
    try {
      _value = LoggedUserAddressModel.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
    }
  ...
  @override
  Future<AddAddressResponse> addNewAddress(UserAddressData userAddress) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final _data = <String, dynamic>{};
