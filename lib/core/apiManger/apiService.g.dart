...
class _ApiService implements ApiService {
  ...
  Future<GetLoggedCartResponse> getLoggedCart(String token) async {
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late GetLoggedCartResponse _value;
    try {
      _value = GetLoggedCartResponse.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
    }
  ...
  Future<ClearCartResponse> clearCart(String token) async {
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late ClearCartResponse _value;
    try {
      _value = ClearCartResponse.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
    }
